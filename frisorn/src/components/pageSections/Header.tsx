...
function Header() {
  ...
  /*
    Gjør Header mindre ved scroll
    Problemer med at headeren blir "sticky" i feil pos
    Hard coded breakpoints for å unngå at den flipper mellom states ved små scrollendringer, og legger til event listener for scroll 
  */
  useEffect(() => {
    const onScroll = () => {
    ...
    <div className="sticky top-0 z-50 px-7 pt-2 sm:px-10 lg:px-14">
      ...
      >
        <div className="flex flex-col gap-1">
          <h1 className="font-secondary text-[clamp(1.6rem,2.6vw,2.2rem)] tracking-[0.06em]">
            Frisør'n
          </h1>
